...
{
	#region PluginInfo
	[PluginInfo(Name = "Renderer", Category = "shadertoy", AutoEvaluate = true)]
	#endregion PluginInfo
	public class shadertoyRendererNode : UserControl, IPluginEvaluate, IPartImportsSatisfiedNotification
	{
		#region fields & pins
